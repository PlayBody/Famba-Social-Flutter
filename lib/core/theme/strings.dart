...
class Strings {
  ...
  static final userPhoneNumber = LocaleKeys.phone_number.tr();
  static final userBirthday = LocaleKeys.birthday.tr();
  static final userInstagram = LocaleKeys.instagram.tr();
  static final userTicTok = LocaleKeys.tictok.tr();
  static final userTwitter = LocaleKeys.twitter.tr();
  static final userSnapchat = LocaleKeys.snapchat.tr();
  static final userschoolName = LocaleKeys.school_name.tr();
  static final userDivisionConference = LocaleKeys.division_conference.tr();
  static final userEduAwards = LocaleKeys.awards.tr();
  static final userGpa = LocaleKeys.gpa.tr();
  static final userSports = LocaleKeys.sports.tr();
  static final userCity = LocaleKeys.city.tr();
  static final userStateProfile = LocaleKeys.state_str.tr();
  static final userLevel = LocaleKeys.level_str.tr();
  static final userMonezation =
      LocaleKeys.monetization_appearance_endorsement.tr();
  static final userServiceHours = LocaleKeys.service_hours.tr();
  static final userAwards = LocaleKeys.awards.tr();
